...
Collection.prototype.all = function all(callback) {
  var query = {
    "*": "*"
  }
  this.find_all(query, callback);
}
...
Collection.prototype.raw_solr_query = function raw_solr_query(query, callback) {
  this.client.raw_solr_query(this.name, query, callback);
}
