...
var Collection = function Collection(name, client) {
  ...
  this.get_schema = function get_schema(callback) {
    this.client.get_schema_json(this.name, function(err, result) {
  ...
  this.set_schema = function set_schema(schema, callback) {
    var schema_fields
