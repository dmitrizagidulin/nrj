...
RiakJsonClient.prototype.collection_index_name = function collection_index_name(collection_name) {
  return collection_name + 'RJIndex';
}
...
RiakJsonClient.prototype.raw_solr_query = function raw_solr_query(collection_name, query, callback) {
  var url = this.base_riak_url() + this.base_riak_path() + 'search/' + this.collection_index_name(collection_name);
  this.transport.get_request(url, query, function(err, res){
